...
<body>
	...
	<fieldset>
		...
		<legend>
			<center>EDU 803 AND EDU 903 NAME ENTRY SECTION</center>
			<button type="button" class="btn btn-primary" onclick="location.href='/smspro/'">Add C.A to Student data</button>
		</legend>
		<div class="form-inline">
			<form class="form-row align-items-center" method="post" action="${pageContext.request.contextPath}/saveName">
				
				<div class="col-auto">
					<label for="matno">UJ/2016/PGED/</label> 
				</div>
				
				<div class="col-auto">
					<input type="text" name="matNo" class="form-control" id="matno" placeholder="0000" />
				</div>
				...
				<button type="submit" class="btn btn-primary mb-2">Merge Name to MatNo</button>
			</form>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
